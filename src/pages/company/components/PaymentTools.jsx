        ...
        <div className="space-y-4">
          ...
          {debts.length > 0 && (
            <div className="bg-white/60 rounded-xl p-3 border border-green-100">
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white transition-all text-xs"
              >
                <option value="">
                  {filterCorporateClient
            ...
            <div className="bg-white/60 rounded-xl p-3 border border-green-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <label className={`flex items-center gap-2 p-2 border-2 rounded-lg cursor-pointer transition-all ${
                  ...
                  <span className="text-xs font-medium">Transferencia Bancaria</span>
                </label>
              </div>
            </div>
          )}
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              {paymentMethod === 'transferencia' && (
                <Button
                  ...
                  className="flex-1 text-xs py-2"
                  leftIcon={<Banknote className="w-3 h-3" />}
                >
          ...
          {selectedDebtInfo && selectedCorporateClient && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-3">
              <h4 className="font-semibold text-blue-900 mb-2 flex items-center gap-2 text-xs">
                <User className="w-3 h-3" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
                ...
                <div>
                  ...
                  <span className="font-semibold ml-1">{selectedDebtInfo.user?.full_name || 'N/A'}</span>
                </div>
                <div>
                  <span className="text-blue-700">Monto:</span>
                  <span className="font-semibold ml-1">${selectedDebtInfo.current_amount?.toLocaleString('es-CL')}</span>
                </div>
                <div>
                  <span className="text-blue-700">Descripción:</span>
                  <span className="font-semibold ml-1">{selectedDebtInfo.description || 'Sin descripción'}</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <Badge variant={selectedDebtInfo.status === 'active' ? 'danger' : 'secondary'} className="ml-1" size="sm">
