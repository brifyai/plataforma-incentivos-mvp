    ...
    const { value: formValues } = await Swal.fire({
      ...
      html: `
        <style>
          ...
          .swal2-form-container .mb-3 {
            margin-bottom: 1rem;
          }
          .swal2-form-container label {
            display: block;
            font-size: 0.875rem;
            font-weight: 500;
            color: #374151;
          ...
          .swal2-form-container input,
          .swal2-form-container select {
            width: 100%;
          ...
          .swal2-form-container input:focus,
          .swal2-form-container select:focus {
            outline: none;
            border-color: #3b82f6;
        ...
        <div class="swal2-form-container">
          <div class="mb-3">
            ...
            <input id="swal-input1" placeholder="Ej: Juan Pérez" required>
          </div>
          <div class="mb-3">
            <label>Email *</label>
            <input id="swal-input2" type="email" placeholder="ejemplo@email.com" required>
          </div>
          <div class="mb-3">
            <label>RUT *</label>
          ...
          <div class="mb-3">
            ...
            <input id="swal-input4" type="tel" placeholder="Ej: +56912345678">
          </div>
          <div class="mb-3">
            <label>Monto de Deuda Inicial</label>
            <input id="swal-input5" type="number" placeholder="Ej: 1000000">
          </div>
      ...
      preConfirm: () => {
        ...
        const rut = document.getElementById('swal-input3').value;
        const phone = document.getElementById('swal-input4').value;
        const totalDebt = document.getElementById('swal-input5').value;
        const corporateClientId = corporateClients && corporateClients.length > 0 ? document.getElementById('swal-input6').value : '';
        ...
        return { name, email, rut, phone, totalDebt, corporateClientId };
      }
    });
