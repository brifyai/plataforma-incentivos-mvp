...
const OffersPage = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="relative overflow-hidden bg-gradient-to-br from-accent-600 via-primary-600 to-accent-700 rounded-3xl p-8 text-white shadow-strong animate-fade-in">
        {/* Background pattern */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
              <div className="flex items-center gap-3">
                <Gift className="w-6 h-6 text-success-300" />
                <div>
                  <p className="text-sm text-primary-100">Total Ofertas</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
              <div className="flex items-center gap-3">
                <TrendingUp className="w-6 h-6 text-warning-300" />
                <div>
                  <p className="text-sm text-primary-100">Incentivo Promedio</p>
                  <p className="text-2xl font-bold">{offers.length > 0 ? Math.round(offers.reduce((sum, offer) => sum + (offer.user_incentive_percentage || 0), 0) / offers.length) : 0}%</p>
                </div>
              </div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-primary-100">Vigentes</p>
                  <p className="text-2xl font-bold">{offers.filter(offer => !isOfferExpired(offer)).length}</p>
                </div>
              </div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-primary-100">Aceptadas</p>
                  <p className="text-2xl font-bold">{acceptedOffers.size}</p>
                </div>
              </div>
            </div>
          </div>
