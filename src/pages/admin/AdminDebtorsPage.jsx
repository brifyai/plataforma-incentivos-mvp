    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-1.5 mt-2">
        ...
        <Card className="text-center group hover:scale-[1.02] transition-all duration-300 animate-slide-up">
          <div className="p-1">
            <div className="flex items-center justify-center mb-1.5">
              <div className="p-0.5 bg-gradient-to-br from-red-100 to-red-200 rounded-lg group-hover:shadow-glow-danger transition-all duration-300">
                  ...
                  <div className="p-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="text-lg font-bold text-gray-900 mb-1">{debtor.full_name}</h3>
                          <p className="text-gray-600 text-xs mb-1">{debtor.email}</p>
                          {debtor.rut && (
