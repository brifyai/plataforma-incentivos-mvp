...
-- Description: This migration adds the client_id column to the debts table to establish
--              the relationship between debts and clients. This is needed for proper
--              client-debt management functionality.
