...
-- 3. Crear políticas para que los usuarios puedan leer y actualizar su propia información
...
-- 4. Política para que las empresas puedan ver información de usuarios relacionados
CREATE POLICY "Companies can view related users" ON users
    FOR SELECT USING (
        EXISTS (
            SELECT 1 FROM debts
