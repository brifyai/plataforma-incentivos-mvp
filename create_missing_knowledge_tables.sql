-- Script para crear las tablas faltantes de knowledge base
-- Ejecutar manualmente en la base de datos de Supabase
...
-- Insertar datos de ejemplo para los clientes existentes
...
-- Insertar algunas políticas de ejemplo
