...
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind2bHVxZGxkeWdtZ25jcXFqa293Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNzU2NjM3NCwiZXhwIjoyMDUzMTQyMzc0fQ.qRJkWqjz3hX1mQr9sYhFqZQ5L7X8nK1V2J3m4P5e6T8';
...
FOR DELETE USING (
  ...
  AND auth.role() = 'authenticated'
    ...
    const { data: uploadData, error: uploadError } = await supabase.storage
      .from('verification-documents')
      .upload('test/access-test.txt', testFile, {
        cacheControl: '3600',
        upsert: true
      });
