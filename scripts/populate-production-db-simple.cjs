/**
 * Script simple para poblar la base de datos de producción
 * Solo crea los datos básicos necesarios para que funcionen los portales
 */
...
async function populateDatabase() {
  console.log('🚀 Iniciando población SIMPLE de base de datos...');
  console.log('=' .repeat(60));

  try {
    // 1. Crear usuario administrador (usando UUID real)
    ...
    if (adminError) {
      ...
      console.log('✅ Usuario administrador creado:', adminData.id);
    }
    ...
    if (companyError) {
      ...
      console.log('✅ Empresa de cobranza creada:', companyData.id);
    }
    ...
    if (corpClientError) {
      ...
      console.log('✅ Cliente corporativo creado:', corpClientData.id);
    }
    ...
    if (clientError) {
      ...
      console.log('✅ Cliente específico creado:', clientData.id);
    }
    ...
    if (debtorError) {
      ...
      console.log('✅ Usuario deudor creado:', debtorData.id);
    }
    ...
    if (debtError) {
      ...
      console.log('✅ Deuda creada:', debtData.id);
    }
