-- Script para agregar SOLO los datos que faltan para que funcionen los portales
-- Basado en la verificación: ya existe admin@nexupay.cl, pero faltan empresa, clientes y deudas

-- 1. Crear empresa de cobranza (si no existe)
...
-- 2. Crear cliente corporativo (si no existe)
...
-- 3. Crear cliente específico (si no existe)
...
-- 4. Crear usuario deudor (si no existe)
...
-- Mostrar emails de usuarios para login
