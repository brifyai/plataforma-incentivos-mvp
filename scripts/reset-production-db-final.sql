-- Script FINAL para resetear producción - SOLO COLUMNAS QUE EXISTEN
...
-- PASO 2: Crear empresa de producción (solo columnas que existen)
...
-- PASO 3: Crear cliente corporativo (solo columnas que existen)
INSERT INTO public.corporate_clients (
  id, contact_email, contact_phone, rut, industry, credit_limit, created_at, updated_at
)
VALUES
  (gen_random_uuid(), 'cliente@empresa.cl', '+56911223344', '98765432-1', 'Tecnología', 100000000, NOW(), NOW());
