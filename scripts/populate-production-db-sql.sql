-- Script SQL para poblar la base de datos de producción con datos de prueba
...
INSERT INTO public.companies (id, user_id, business_name, contact_email, contact_phone, rut, nexupay_commission, nexupay_commission_type, user_incentive_percentage, user_incentive_type, validation_status, created_at, updated_at)
SELECT
  gen_random_uuid(),
  u.id,
  'NexuPay Cobranzas',
