/**
 * Script corregido para poblar la base de datos de producción
 * Solo usa las columnas que realmente existen según la verificación
 */
...
async function populateProductionFixed() {
  console.log('🚀 Poblando base de datos de producción (versión corregida)...');
  console.log('=' .repeat(70));

  try {
    // 1. Crear usuario empresa (solo columnas que existen)
    ...
    // 2. Crear empresa de cobranza (solo columnas que existen)
    ...
    // 3. Crear cliente corporativo (solo columnas que existen)
    ...
    // 4. Crear cliente específico (solo columnas que existen)
    ...
    // 5. Crear usuario deudor (solo columnas que existen)
    ...
    // 6. Crear deuda (solo columnas que existen)
