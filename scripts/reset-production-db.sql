-- Script para LIMPIAR y RECREAR datos de producción
-- Ejecutar en Supabase Dashboard > SQL Editor

-- PASO 1: Limpiar datos existentes (orden inverso de dependencias)
DELETE FROM public.debts;
DELETE FROM public.clients;
DELETE FROM public.corporate_clients;
DELETE FROM public.companies;
DELETE FROM public.users WHERE email != 'admin@nexupay.cl'; -- Mantener solo admin

-- PASO 2: Crear empresa de producción
...
-- PASO 3: Crear cliente corporativo de producción
INSERT INTO public.corporate_clients (
  id, contact_email, contact_phone, rut, industry, company_size, credit_limit, created_at, updated_at
)
VALUES
  (gen_random_uuid(), 'cliente@empresa.cl', '+56911223344', '98765432-1', 'Tecnología', 'large', 100000000, NOW(), NOW());
...
SELECT '🎉 BASE DE DATOS DE PRODUCCIÓN LISTA:' as status;
SELECT
...
SELECT '✅ ¡PRODUCCIÓN CONFIGURADA!' as mensaje UNION ALL
