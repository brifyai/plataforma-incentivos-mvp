-- Script FINAL SIMPLE - Solo datos esenciales
...
-- PASO 3: Crear cliente corporativo con company_id
INSERT INTO public.corporate_clients (
  id, company_id, contact_email, contact_phone, rut, industry, created_at, updated_at
)
SELECT
  gen_random_uuid(),
  c.id,
