-- Script FINAL que funciona - solo columnas que realmente existen
-- Ejecutar en Supabase Dashboard > SQL Editor

-- 1. Crear empresa con SOLO las columnas que existen
INSERT INTO public.companies (
  id, user_id, company_name, rut, contact_email, contact_phone,
  creditor_type, nexupay_commission_type, nexupay_commission,
...
SELECT '✅ DATOS COMPLETADOS:' as status;
SELECT
