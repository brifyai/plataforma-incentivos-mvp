-- Script que FUNCIONA - Solo columnas que existen en tu BD
-- Ejecutar en Supabase Dashboard > SQL Editor

-- 1. Crear empresa con columnas mínimas
...
-- 2. Crear cliente corporativo (solo columnas que existen)
INSERT INTO public.corporate_clients (id, contact_email, contact_phone, rut, industry, company_size, credit_limit, created_at, updated_at)
SELECT
  gen_random_uuid(),
...
SELECT '✅ ¡LISTO! Ahora puedes probar todos los portales:' as mensaje UNION ALL
SELECT '   • Portal Admin: admin@nexupay.cl' UNION ALL
SELECT '   • Portal Empresa: empresa@nexupay.cl' UNION ALL
SELECT '   • Portal Personas: hola@aintelligence.cl' UNION ALL
SELECT '   • Contraseña: 123456 (o configúrala)';