-- =====================================================
-- CREAR TABLAS DE KNOWLEDGE BASE COMPLETAS (VERSION CORREGIDA)
-- =====================================================
...
-- 7. Crear políticas RLS (versión segura sin IF NOT EXISTS)
DROP POLICY IF EXISTS "Users can manage AI config for their companies" ON negotiation_ai_config;
CREATE POLICY "Users can manage AI config for their companies" ON negotiation_ai_config
    FOR ALL USING (
        company_id IN (
...
DROP POLICY IF EXISTS "Users can manage policies for their companies" ON corporate_client_policies;
...
DROP POLICY IF EXISTS "Users can manage responses for their companies" ON corporate_client_responses;
...
DROP POLICY IF EXISTS "Users can manage knowledge base for their companies" ON company_knowledge_base;
